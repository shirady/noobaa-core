...
function make_dummy_account_sdk_from_root_accounts_manager(account, root_account_manager_id) {
    const dummy_account_sdk = make_dummy_account_sdk_iam_user(account, root_account_manager_id);
...
describe('Accountspace_FS tests', () => {
    ...
    describe('Accountspace_FS Users tests', () => {
        ...
        describe('create_user', () => {
            ...
            it('create_user should return user params (requesting account is root accounts manager to create root account user)', async function() {
                const params = {
        ...
        describe('get_access_key_last_used', () => {
            ...
            it('get_access_key_last_used return an error if user is not owned by the root account (requester is an IAM user)', async function() {
                try {
                    ...
                    // by the IAM user
                    account_sdk = make_dummy_account_sdk_iam_user(requester_account_config_file, requester_account_config_file.owner);
