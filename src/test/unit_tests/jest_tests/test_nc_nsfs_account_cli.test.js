...
describe('manage nsfs cli account flow', () => {
    ...
    describe('cli update account', () => {
        describe('cli update account (has uid and gid)', () => {
            ...
            it('cli update account unset flag iam_operate_on_root_account', async function() {
                ...
                // unset iam_operate_on_root_account
                const empty_string = '\'\'';
                account_options.iam_operate_on_root_account = empty_string;
                await exec_manage_cli(type, action, account_options);
                new_account_details = await read_config_file(config_root, CONFIG_SUBDIRS.ACCOUNTS, name);
                expect(new_account_details.iam_operate_on_root_account).toBeUndefined();
            });
