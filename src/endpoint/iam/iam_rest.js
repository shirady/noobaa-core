...
const IAM_OPS = js_utils.deep_freeze({
    // user CRUD
    post_create_user: require('./ops/iam_post_create_user'),
    post_get_user: require('./ops/iam_get_user'),
    post_update_user: require('./ops/iam_put_update_user'),
    post_delete_user: require('./ops/iam_delete_user'),
    post_list_users: require('./ops/iam_get_users'),
    // access key CRUD
    post_create_access_key: require('./ops/iam_post_create_access_key'),
    post_get_access_key_last_used: require('./ops/iam_get_access_key'),
    post_update_access_key: require('./ops/iam_put_update_access_key'),
    post_delete_access_key: require('./ops/iam_delete_access_key'),
    post_list_access_keys: require('./ops/iam_get_access_keys'),
});
...
function handle_error(req, res, err) {
    ...
    const reply = iam_err.reply(req.originalUrl, req.request_id);
